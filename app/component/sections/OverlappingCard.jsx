  ...
  return (
    <div className="container mx-auto">
      <div className="relative z-50">
        <motion.div
          className="-mb-[200px] w-full bg-[#1E2008] text-white rounded-[35px] p-5 md:p-10 lg:p-10 h-[300px] md:h-[400px] flex-center-between-col"
        ...
        >
          ...
          <motion.button
            className="rounded-[8px] bg-[#B9FD50] text-[#111204] py-3 px-6 md:py-5 md:px-10 font-outfit font-medium text-base"
            initial={{ scale: 1 }}
