...
const ContactUs = () => {
  ...
  return (
    ...
    //     </div>
    //   </div>
    //   <div className="w-full flex-center-between-row mt-7 flex-col md:flex-row">
    //     {/* Form Section */}
    //     <form
    //       onSubmit={handleSubmit(onSubmit)}
    //       className="grid grid-cols-1 gap-4 h-full w-full md:w-1/2"
    //     >
    //       <div>
    //         <input
    //           type="text"
    ...
    //     {/* Contact Info Section */}
    //     <div className="bg-[#98e209] w-full md:w-[480px] h-auto card-shadow p-[30px] rounded-[20px] flex justify-between flex-col mt-8 md:mt-0">
    //       <div>
    //         <h3 className="text-h3 font-semibold text-[24px]">Address</h3>
    //         <p className="text-sm font-medium text-[#5b6e38] mt-1">
    //           C9-502 Rashmi star city naigoan east, Mumbai, Maharashtra 401208
